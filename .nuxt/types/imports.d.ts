...
declare global {
  ...
  const { cookieToken, getToken, getUser, removeToken, setToken }: typeof import('../../src/composables/useAuth')
  const { default: useRequest }: typeof import('../../src/composables/useRequest')
  ...
  const { redirectTo, throwFormError }: typeof import('../../src/composables/useCommon')
  ...
  const { useAuthStore }: typeof import('../../src/stores/auth')
  const { useContentStore }: typeof import('../../src/stores/content')
