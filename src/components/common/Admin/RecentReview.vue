<template>
    <div class="w-full rounded-lg bg-white border border-gray-200 box-border h-[415px] flex flex-col items-start p-6 gap-4 text-left text-xl text-gray-900 font-plus-jakarta-sans">
      <!-- Header -->
  ...
  const reviews = [
    {
      ...
      rating: '4.5',
      date: '12-June-2025',
      review: 'Great service and quick response time...',
      status: 'Pending'
    },
    {
    ...
    },
    {
      ...
      rating: '4.0',
      date: '09-June-2025',
      review: 'Very professional and courteous staff...',
      status: 'Approved'
    },
    {
    ...
    },
    {
      ...
      rating: '4.5',
      date: '07-June-2025',
      review: 'Amazing product quality and delivery...',
      status: 'Approved'
    },
    {
      ...
      rating: '5.0',
      date: '06-June-2025',
      review: 'Outstanding service, will use again...',
      status: 'Approved'
    }
  ];
