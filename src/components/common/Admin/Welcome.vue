<template>
  ...
  >
    ...
    <!-- Search Bar -->
    <div
      class="w-full rounded-lg bg-white/30 border border-white flex items-center px-4 py-3 gap-3 text-gray-200"
    >
      <Search class="w-5 h-5" />
      <span class="capitalize">Search companies by name or category</span>
    </div>
