<template>
  <button
      ...
      :class="`relative flex align-middle items-center justify-center py-4 pl-4 pr-12 overflow-hidden font-semibold text-white
       transition-all duration-150 ease-in-out rounded-lg hover:pl-10 hover:pr-6 hover:shadow-lg bg-[#17107F] group shadow-lg
  ...
  >
    ...
    <template v-else>
      <span class="absolute bottom-0 left-0 w-full h-1 transition-all duration-150 ease-in-out bg-[#DDA300] group-hover:h-full disabled:group-hover:h-1"></span>
