<template>
  <div class="flex justify-center py-2 bg-white">
    ...
    <div class="flex flex-col lg:flex-row items-stretch gap-6 w-full">
      ...
      <div class="w-full m:w-[65%] lg:flex-[1.7] shadow-lg shadow-gray-200/50 bg-white border border-gray-200 rounded-xl flex flex-col items-start p-6 gap-6 min-w-0">
        ...
        <div class="self-stretch px-4 flex flex-col items-start pl-0 sm:pl-7 gap-4 text-left text-sm text-gray-600">
          
          <div class="flex items-start gap-3 w-full flex-wrap text-[16px]">
            ...
            <span v-else class="break-words text-gray-500 min-w-0">www.Mongolia Explorer Travel.com</span>
          </div>
          ...
          <div class="flex items-start gap-3 w-full flex-wrap text-[16px]">
            ...
            <div class="font-medium hidden sm:block">:</div>
            <div class="break-words text-gray-700 min-w-0">{{ email || 'yellow.com@gmail.com' }}</div>
          </div>
          ...
          <div class="flex items-start gap-3 w-full flex-wrap text-[16px]">
            ...
            <div class="font-medium hidden sm:block">:</div>
            <div class="break-words text-gray-700 min-w-0">{{ location || 'Ulaanbaatar, Mongolia' }}</div>
          </div>
          ...
          <div class="flex items-start gap-3 w-full flex-wrap text-[16px]">
            ...
            <div class="font-medium hidden sm:block">:</div>
            <div class="break-words text-gray-700 min-w-0">{{ revenue || '10000000' }}</div>
          </div>
          ...
          <div class="flex items-start gap-3 w-full flex-wrap text-[16px]">
            ...
            <div class="font-medium hidden sm:block">:</div>
            <div class="break-words text-gray-700 min-w-0">{{ employees || '100' }}</div>
          </div>
          ...
          <div class="flex items-start gap-3 w-full flex-wrap text-[16px]">
            ...
            <div class="font-medium hidden sm:block">:</div>
            <div class="break-words text-gray-700 min-w-0">{{ industry || 'Mongolo' }}</div>
          </div>
          ...
          <div class="flex items-start gap-3 w-full flex-wrap text-[16px]">
            ...
            <div class="font-medium hidden sm:block">:</div>
            <div class="break-words text-gray-700 min-w-0">{{ category || 'Software Company' }}</div>
          </div>
      ...
      <!-- Right Card -->
      <div class="w-full lg:flex-[1.3] shadow-lg shadow-gray-200/50 bg-white border border-gray-200 rounded-xl flex flex-col items-center p-6 gap-6">
