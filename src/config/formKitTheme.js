...
const textFieldStyles = {
  outer: "mb-6 border-none formkit-disabled:opacity-40",
  ...
  inner: `
        ...
        `,
  input:
    "w-full h-10 px-4 border-none text-base text-gray-700 placeholder-gray-400",
  help: "text-xs text-gray-500",
  message: "text-red-500 mb-1 text-base font-medium",
...
export default {
  ...
  global: {
    ...
    help: "text-xs text-gray-500",
    inner:
      "min-w-full max-w-full rounded-lg formkit-disabled:bg-gray-200 formkit-disabled:cursor-not-allowed formkit-disabled:pointer-events-none",
    input:
  ...
  password: textFieldStyles,
  email: textFieldStyles,
  ...
  "family:box": {
    ...
    help: "mb-2 mt-1.5",
    input:
      "fixed left-[999em] w-0 h-0 overflow-hidden opacity-0 pointer-events-none peer",
    label: "$reset text-sm text-gray-700 mt-1 select-none",
    wrapper: "flex items-center mb-1",
  },
  "family:button": {
    input:
      "$reset inline-flex items-center bg-primary-color text-white text-sm font-normal py-3 px-6 rounded",
    wrapper: "mb-1",
  ...
  tel: {
    inner:
      "flex items-center max-w-md ring-1 ring-gray-400 focus-within:ring-blue-500 focus-within:ring-2 [&>label:first-child]:focus-within:text-blue-500 rounded mb-1",
    input:
      "w-full px-3 py-3 rounded-lg border-none text-base text-gray-700 placeholder-gray-400",
  },
  text: {
    inner:
      "flex items-center max-w-md ring-1 ring-gray-400 focus-within:ring-blue-500 focus-within:ring-2 [&>label:first-child]:focus-within:text-blue-500 rounded mb-1",
