...
const modules = import.meta.glob('@/components/UserProfile/*.vue')

const aliasMap: Record<string, string[]> = {
  'favourite-companies': ['favouriteCompanies'],
...
<template>
  <div class="w-full space-y-6">
    ...
    <div v-else-if="showNotFound" class="p-6">
      ...
      <p class="text-gray-600">No matching user profile component for this route.</p>
    </div>
  </div>
</template>
