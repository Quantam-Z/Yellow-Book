...
import {
  ...
  warningHandler,
  watchRegistry
} from "./chunk-HT5AW2KA.js";
import {
  __export
} from "./chunk-HKJ2B2AA.js";

// node_modules/@formkit/vue/dist/index.dev.mjs
import { defineComponent, getCurrentInstance, markRaw, watch as watch2, watchEffect, reactive, onMounted, onUnmounted, ref, provide, h, inject, computed, toRef, onBeforeUnmount, KeepAlive, Suspense, nextTick, triggerRef, isRef, isReactive, createTextVNode, resolveComponent } from "vue";
...
var init_bindings = __esm({
  "packages/vue/src/bindings.ts"() {
    vueBindings = function vueBindings2(node) {
      ...
      watch2(validationVisible, (value2) => {
        if (value2) {
...
var FormKitRoot = defineComponent((_p, context) => {
  ...
  const stopWatch2 = watch2(boundary, (el) => {
    let parent = el;
    let root = null;
